          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 pt-2">
              <p className="text-white text-sm">
                Tryck på <span className="inline-flex items-center justify-center w-6 h-6 bg-blue-500/30 rounded mx-1 align-middle"><IOSShareIcon className="text-blue-400" /></span> <strong>Dela-knappen</strong> i Safari
              </p>
            </div>
          </div>
